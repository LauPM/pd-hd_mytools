...
for variable in ['pulse_bias_percent_270nm']:
    ...
    # for i in range(1350,1500,10):
        ...
        a = subprocess.call(f"sh run_calib.sh lperez np04_DAPHNE_APAs34_SSP.json 60 Calibration\ Run.\ Bias\ DCS:15V.\ Tests\ 270nm:SSP_config.\ Pulse_bias_percent_270nm:{i} True",shell=True)          
